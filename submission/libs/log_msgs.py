...
purpose:        Contains the logger messages
version:        1.0
"""

# ERR
INVALID_CHOICE_ERR = "ERR: Invalid choice. Please enter the number for the given options."
INVALID_DIMENSION_ERR = "ERR: Grid dimension should be integer."
